...
STRINGS = {
    ...
    "btn_tools": {"fa": "🧰 ابزارهای سریع", "en": "🧰 Quick tools"},
    "btn_usage": {"fa": "📊 مصرف و سهمیه", "en": "📊 Usage & quota"},
    ...
    "feature_disabled": {"fa": "🔒 این قابلیت برای اشتراک شما فعال نیست: <b>{feature}</b>", "en": "🔒 This capability is not enabled for your plan: <b>{feature}</b>"},
    "ai_no_models": {
    ...
    "btn_style": {"fa": "🎨 سبک پاسخ", "en": "🎨 Response style"},
    ...
    "tools_title": {
        "fa": "🧰 <b>ابزارهای سریع</b>\n\nصفحه {page} — برای پیام بعدی یک ابزار انتخاب کنید:",
        "en": "🧰 <b>Quick tools</b>\n\nPage {page} — choose a tool for your next message:",
    },
    "tool_summarize": {"fa": "📝 خلاصه‌سازی", "en": "📝 Summarize"},
    "tool_translate": {"fa": "🌍 ترجمه", "en": "🌍 Translate"},
    "tool_rewrite": {"fa": "✨ بازنویسی حرفه‌ای", "en": "✨ Rewrite professionally"},
    "tool_code": {"fa": "💻 دستیار کدنویسی", "en": "💻 Coding assistant"},
    "tool_receipt": {"fa": "🧾 تحلیل رسید/فاکتور", "en": "🧾 Receipt/invoice analysis"},
    "tool_deep": {"fa": "🧠 فکر عمیق", "en": "🧠 Deep thinking"},
    "tool_search": {"fa": "🔎 جست‌وجوی وب", "en": "🔎 Web search"},
    "tool_research": {"fa": "📚 تحقیق چندمنبعی", "en": "📚 Multi-source research"},
    "tool_factcheck": {"fa": "✅ راستی‌آزمایی", "en": "✅ Fact check"},
    "tool_compare": {"fa": "⚖️ مقایسه هوشمند", "en": "⚖️ Smart comparison"},
    "tool_email": {"fa": "✉️ نویسنده ایمیل", "en": "✉️ Email writer"},
    "tool_resume": {"fa": "👔 رزومه‌ساز", "en": "👔 Resume builder"},
    "tool_marketing": {"fa": "📣 تولید محتوای تبلیغاتی", "en": "📣 Marketing copy"},
    "tool_url": {"fa": "🌐 تحلیل لینک", "en": "🌐 URL analysis"},
    "tool_json": {"fa": "🧩 خروجی JSON", "en": "🧩 JSON output"},
    "tool_bullets": {"fa": "📌 خروجی نکته‌ای", "en": "📌 Bullet output"},
    "tool_table": {"fa": "📋 خروجی جدولی", "en": "📋 Table output"},
    "tool_calculator": {"fa": "🧮 ماشین‌حساب", "en": "🧮 Calculator"},
    "tool_datetime": {"fa": "🕒 تاریخ و ساعت", "en": "🕒 Date & time"},
    "tool_export": {"fa": "📤 خروجی گرفتن از چت", "en": "📤 Export chat"},
    "tools_page": {"fa": "صفحه {page}", "en": "Page {page}"},
    "tool_searching": {"fa": "🔎 در حال جست‌وجو و جمع‌آوری منابع...", "en": "🔎 Searching and collecting sources..."},
    "tool_search_failed": {"fa": "⚠️ جست‌وجوی وب انجام نشد؛ پاسخ بدون وب ادامه پیدا می‌کند.", "en": "⚠️ Web search failed; continuing without browsing."},
    "calculator_result": {"fa": "🧮 نتیجه: <code>{result}</code>", "en": "🧮 Result: <code>{result}</code>"},
    "calculator_error": {"fa": "⚠️ عبارت محاسباتی نامعتبر یا ناامن است.", "en": "⚠️ The expression is invalid or unsafe."},
    "datetime_result": {"fa": "🕒 زمان فعلی UTC: <code>{value}</code>", "en": "🕒 Current UTC time: <code>{value}</code>"},
    "export_empty": {"fa": "📭 هنوز گفتگویی برای خروجی گرفتن وجود ندارد.", "en": "📭 There is no conversation to export yet."},
    "export_ready": {"fa": "📤 فایل خروجی گفتگو آماده شد.", "en": "📤 Your chat export is ready."},
    "research_sources": {"fa": "منابع استفاده‌شده", "en": "Sources used"},
    "tool_selected": {"fa": "✅ ابزار برای پیام بعدی فعال شد: <b>{tool}</b>", "en": "✅ Tool enabled for the next message: <b>{tool}</b>"},
    "style_title": {"fa": "🎨 <b>سبک پاسخ</b>\n\nسبک پاسخ‌های بعدی را انتخاب کنید:", "en": "🎨 <b>Response style</b>\n\nChoose the style for future replies:"},
    "style_concise": {"fa": "⚡ کوتاه و سریع", "en": "⚡ Concise"},
    "style_balanced": {"fa": "⚖️ متعادل", "en": "⚖️ Balanced"},
    "style_detailed": {"fa": "📚 کامل و آموزشی", "en": "📚 Detailed"},
    "style_formal": {"fa": "💼 رسمی و حرفه‌ای", "en": "💼 Formal"},
    "style_selected": {"fa": "✅ سبک پاسخ روی <b>{style}</b> تنظیم شد.", "en": "✅ Response style set to <b>{style}</b>."},
    "usage_title": {
        "fa": "📊 <b>مصرف و سهمیه من</b>\n\n▫️ پلن: <b>{plan}</b>\n▫️ حالت سهمیه: <b>{mode}</b>\n▫️ پیام مصرف‌شده: <b>{used}</b> از <b>{limit}</b>\n▫️ پیام باقی‌مانده: <b>{remaining}</b>\n▫️ توکن مصرف‌شده: <b>{token_used}</b> از <b>{token_limit}</b>\n▫️ توکن باقی‌مانده: <b>{token_remaining}</b>\n▫️ انقضا: <b>{expire}</b>",
        "en": "📊 <b>My usage & quota</b>\n\n▫️ Plan: <b>{plan}</b>\n▫️ Quota mode: <b>{mode}</b>\n▫️ Messages used: <b>{used}</b> of <b>{limit}</b>\n▫️ Messages left: <b>{remaining}</b>\n▫️ Tokens used: <b>{token_used}</b> of <b>{token_limit}</b>\n▫️ Tokens left: <b>{token_remaining}</b>\n▫️ Expires: <b>{expire}</b>",
    },
    "ai_failed": {
    ...
    "btn_admin_features": {"fa": "⚡ قابلیت‌ها", "en": "⚡ Capabilities"},

    "capabilities_title": {
        "fa": "⚡ <b>قابلیت‌ها</b>\n\nمحدوده: <b>{scope}</b>\nصفحه {page} از {pages}\nبرای هر قابلیت دکمه را بزنید تا روشن/خاموش یا مقدارش تغییر کند:",
        "en": "⚡ <b>Capabilities</b>\n\nScope: <b>{scope}</b>\nPage {page} of {pages}\nTap a capability to toggle it or cycle its value:",
    },
    "capability_saved": {"fa": "✅ قابلیت ذخیره شد.", "en": "✅ Capability saved."},
    "admin_stats_body": {
    ...
    "btn_user_features": {"fa": "⚡ قابلیت‌های کاربر", "en": "⚡ User capabilities"},
    "btn_custom_value": {"fa": "✍️ مقدار دلخواه", "en": "✍️ Custom value"},
    "btn_quota_messages": {"fa": "💬 سهمیه بر اساس پیام", "en": "💬 Message-based quota"},
    "btn_quota_tokens": {"fa": "🪙 سهمیه بر اساس توکن", "en": "🪙 Token-based quota"},
    "btn_quota_both": {"fa": "🔒 پیام و توکن باهم", "en": "🔒 Messages and tokens"},
    "btn_all_models": {"fa": "🌐 همه مدل‌ها", "en": "🌐 All models"},
    "quota_value_title": {"fa": "مقدار سهمیه را انتخاب کنید:", "en": "Choose the quota amount:"},
    "policy_saved": {"fa": "✅ سیاست ذخیره شد.", "en": "✅ Policy saved."},
    ...
    "btn_product_features": {"fa": "⚡ قابلیت‌های پلن", "en": "⚡ Plan capabilities"},
